 ...
 * <ul>
 *   <li>{@link SecCon.SecCon.impl.TransitionImpl#getTrigger <em>Trigger</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	protected EClass eStaticClass() {
		return SecConPackage.Literals.TRANSITION;
	}
		...
		if (trigger != null && trigger.eIsProxy()) {
			...
			if (trigger != oldTrigger) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SecConPackage.TRANSITION__TRIGGER, oldTrigger, trigger));
			}
		}
		return trigger;
	}
	...
	public void setTrigger(Event newTrigger) {
		...
		trigger = newTrigger;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecConPackage.TRANSITION__TRIGGER, oldTrigger, trigger));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SecConPackage.TRANSITION__TRIGGER:
