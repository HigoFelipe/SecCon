 ...
 * <ul>
 *   <li>{@link SecCon.SecCon.impl.CommentImpl#getBody <em>Body</em>}</li>
 *   <li>{@link SecCon.SecCon.impl.CommentImpl#getAnnotatedElement <em>Annotated Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommentImpl extends MinimalEObjectImpl.Container implements Comment {
	...
	protected EClass eStaticClass() {
		return SecConPackage.Literals.COMMENT;
	}
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecConPackage.COMMENT__BODY, oldBody, body));
	}
	...
	public EList<Element> getAnnotatedElement() {
		if (annotatedElement == null) {
			annotatedElement = new EObjectResolvingEList<Element>(Element.class, this, SecConPackage.COMMENT__ANNOTATED_ELEMENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SecConPackage.COMMENT__BODY:
				return getBody();
			case SecConPackage.COMMENT__ANNOTATED_ELEMENT:
