 ...
 * <ul>
 *   <li>{@link SecCon.SecCon.impl.EnumerationImpl#getOwnedLiteral <em>Owned Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return SecConPackage.Literals.ENUMERATION;
	}
	...
	public EList<EnumerationLiteral> getOwnedLiteral() {
		if (ownedLiteral == null) {
			ownedLiteral = new EObjectContainmentWithInverseEList<EnumerationLiteral>(EnumerationLiteral.class, this, SecConPackage.ENUMERATION__OWNED_LITERAL, SecConPackage.ENUMERATION_LITERAL__ENUMERATION);
		}
		return ownedLiteral;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SecConPackage.ENUMERATION__OWNED_LITERAL:
